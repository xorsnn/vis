...
class Canvas {
  ...
  setSize(width = this.options.width, height = this.options.height) {
    ...
    if (width != this.options.width || height != this.options.height || this.frame.style.width != width || this.frame.style.height != height) {
      ...
      // there is a change.
      console.log('location two before',
        this.frame.canvas.width != Math.round(this.frame.canvas.clientWidth * this.pixelRatio),
        this.frame.canvas.height != Math.round(this.frame.canvas.clientHeight * this.pixelRatio),
      this.frame.canvas.width, this.frame.canvas.clientWidth, this.frame.canvas.height, this.frame.canvas.clientHeight, this.pixelRatio);
