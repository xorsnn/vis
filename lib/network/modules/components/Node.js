...
class Node {
  constructor(options, body, imagelist, grouplist, globalOptions) {
    ...
    this.controlsModule = new Controls(this.body, this.options);
  ...
  updateShape(currentShape) {
    if (currentShape === this.options.shape && this.shape) {
      ...
      switch (this.options.shape) {
        case 'box':
          this.shape = new Box(this.options, this.body, this.labelModule, this.controlsModule);
          break;
        case 'circle':
          this.shape = new Circle(this.options, this.body, this.labelModule, this.controlsModule);
          break;
        case 'circularImage':
          this.shape = new CircularImage(this.options, this.body, this.labelModule, this.imageObj);
          break;
        case 'database':
          this.shape = new Database(this.options, this.body, this.labelModule, this.controlsModule);
          break;
        case 'diamond':
          this.shape = new Diamond(this.options, this.body, this.labelModule, this.controlsModule);
          break;
        case 'dot':
          this.shape = new Dot(this.options, this.body, this.labelModule, this.controlsModule);
          break;
        case 'ellipse':
          this.shape = new Ellipse(this.options, this.body, this.labelModule, this.controlsModule);
          break;
        case 'icon':
          this.shape = new Icon(this.options, this.body, this.labelModule, this.controlsModule);
          break;
        case 'image':
          this.shape = new Image(this.options, this.body, this.labelModule, this.imageObj);
          break;
        case 'square':
          this.shape = new Square(this.options, this.body, this.labelModule, this.controlsModule);
          break;
        case 'star':
          this.shape = new Star(this.options, this.body, this.labelModule, this.controlsModule);
          break;
        case 'text':
          this.shape = new Text(this.options, this.body, this.labelModule, this.controlsModule);
          break;
        case 'triangle':
          this.shape = new Triangle(this.options, this.body, this.labelModule, this.controlsModule);
          break;
        case 'triangleDown':
          this.shape = new TriangleDown(this.options, this.body, this.labelModule, this.controlsModule);
          break;
        default:
          this.shape = new Ellipse(this.options, this.body, this.labelModule, this.controlsModule);
          break;
  ...
  isOverlappingWith(obj) {
    return (
      ...
      this.controlsModule.isOverlappingWith(obj)
    );
  }
